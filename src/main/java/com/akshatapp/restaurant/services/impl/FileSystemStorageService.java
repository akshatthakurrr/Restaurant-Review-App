...
import com.akshatapp.restaurant.services.StorageService;
...
public class FileSystemStorageService implements StorageService {
    ...
    public void init(){
        ...
        try {
            ...
            throw new Storageexeption("could not initialize storage location",e);
        }
    }
    ...
    public String store(MultipartFile file, String filename) {
        try {
            if (file.isEmpty()) {
                throw new Storageexeption("cannot save  an empty file");
            ...
            if (!destinationFile.getParent().equals(rootLocation.toAbsolutePath())) {
                throw new Storageexeption("cannot store file outside directory");
            }
    ...
    public Optional<Resource> loadAsResource(String filename) {
       ...
       if(resource.exists()  ||  resource.isReadable())  {
           ...
           return Optional.empty();
            ...
            log.warn("could not read file".formatted(filename), e);
            return Optional.empty();
        }
}}