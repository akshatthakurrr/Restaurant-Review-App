...
import com.akshatapp.restaurant.domain.dtos.RestaurantCreateUpdateDto;
import com.akshatapp.restaurant.domain.dtos.RestaurantDto;
import com.akshatapp.restaurant.domain.dtos.RestaurantSummaryDto;
import com.akshatapp.restaurant.domain.entities.Restaurant;
import com.akshatapp.restaurant.mappers.RestaurantMappers;
...
public class RestaurantController {
    ...
    private final RestaurantMappers restaurantMapper;
    @PostMapping
    public ResponseEntity<RestaurantDto> createRestaurant(
            @Valid @RequestBody RestaurantCreateUpdateDto request
    ) {
        RestaurantCreateUpdate restaurantCreateUpdateRequest = restaurantMapper
                .toRestaurantCreateUpdate(request);
...
public ResponseEntity<RestaurantDto> getRestaurant(@PathVariable("restaurant_id") String restaurantId) {
    ...
    public ResponseEntity<RestaurantDto> updateRestaurant(
        ...
        RestaurantCreateUpdate request =
                restaurantMapper.toRestaurantCreateUpdate(requestDto);
