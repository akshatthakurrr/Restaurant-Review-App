package com.akshatapp.restaurant.mannual;
...
public class RestaurantDataLoaderTest {
        ...
        List<RestaurantCreateUpdate> restaurants = createRestaurantData();
...
private List<RestaurantCreateUpdate> createRestaurantData() {
...
private RestaurantCreateUpdate createRestaurant(
        String name,
        String cuisineType,
        ...
        return RestaurantCreateUpdate.builder()
                .name(name)
